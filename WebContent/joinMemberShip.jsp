		...
		<form action="joinMemberShip" method="post" id="joinMemberShipForm" name="joinMemberShipForm">
			<div>
				<p>
					...
					<input type="text" name="mid" id="mid" class="formControl" maxlength="12"  >
					  4~12자리의 영문 대소문자와 숫자로만 입력 &nbsp;&nbsp;&nbsp; 
					<input type="button" id="idCheck" name= "idCheck" value="중복확인" > <!-- onclick="idCheck_btn()" -->  
					<!-- <button id="idCheck" onclick="idCheck()" >중복확인</button> -->
					  <!-- <button id="mid_checkBtn">중복확인</button> --> 
				</p>
				<p>
					...
					4~12자리의 영문 대소문자와 숫자로만 입력
				 	...
				 	<label>비밀번호확인<span style="color: red">*</span></label>
				...
				<p>
					<label>주민등록번호<span style="color: red">*</span></label> 
					<input	type="text" name="mjumin" id="mjumin" class="formControl" >
					예)123456-1234567
				</p>
				<p>
					<label>주소<span style="color: red">*</span></label>
					<input type="text" name="maddress" id="maddress" class="formControl" o>
				</p>
				<p>
				...
				<input type="button" value="회원가입" onclick="join_btn()">
